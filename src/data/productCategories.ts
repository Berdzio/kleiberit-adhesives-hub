...
export const standaloneProducts: { categorySlug: string; product: Product }[] = [
  ...
  },
  {
    ...
    product: {
      ...
      image: "/placeholder.svg",
      details: {
        body: "Kleiberit 541.6 to dwukomponentowy klej poliuretanowy (2K PUR) mieszany z utwardzaczem 870.0 w proporcji wagowej A:B = 4:1. Przeznaczony do klejenia styropianu (EPS), pianki poliuretanowej (PUR/PIR) z blachą stalową, aluminiową, GRP (glass-reinforced plastic) oraz płytami sandwich. Wyjątkowa odporność na temperatury do +90°C i odporność chemiczna czynią go niezastąpionym w produkcji filtrów przemysłowych (olej, diesel, nafta). Shore D ok. 80 gwarantuje twardą i sztywną spoinę przy zachowaniu szczelności.",
        ...
        specs: [
          ...
          { label: "Żywotność (pot life)", value: "ok. 45 min" },
        ...
        applications: "Panele sandwich EPS/XPS/PUR + blacha lub GRP · filtry przemysłowe (olej, diesel, nafta) · elementy izolacyjne odporne na temperaturę do +90°C.",
      },
    },
  },
  ...
  },
  {
    ...
    product: {
      ...
      badge: "D4",
      details: {
        body: "Kleiberit 568.0 Supracon to jednokomponentowy klej na bazie poliuretanu sieciujący pod wpływem wilgoci z powietrza. Wyróżnia się ekstremalnie szybkim wiązaniem i wysoką wytrzymałością początkową — elementy można obciążać już po 15–30 minutach. Osiąga klasę wodoodporności D4 wg DIN EN 204 i odporności termicznej WATT 91. Bez rozpuszczalników, bez korozji, bez zapachu. Wersja 568.0 w kartuszu 310 ml, identyczne parametry jak 568.1 (400 ml).",
        keyFeature: "Klasa D4 + WATT 91 · czas otwarty 5 min · obciążalność po 15–30 min · skuteczny od +7°C. Najszybszy klej montażowy PUR w certyfikacie D4.",
        specs: [
          { label: "Baza", value: "1K PUR" },
          { label: "Klasa", value: "D4 (DIN EN 204) + WATT 91" },
          { label: "Barwa", value: "Jasnobeżowy" },
          { label: "Gęstość", value: "ok. 1,48 g/cm³" },
          { label: "Min. temp. pracy", value: "+7°C" },
          { label: "Czas otwarty", value: "ok. 5 min (20°C/50%)" },
          ...
          { label: "Opakowanie", value: "Kartusz 310 ml" },
        ],
        applications: "Drewno i materiały drewnopochodne · beton, mur, tynk, cement · ceramika, marmur, kamień · twarde PVC, GRP, styropian, PUR · metale: miedź, stal szlachetna, aluminium, stal ocynkowana.",
  ...
  },
  {
    ...
    product: {
      ...
      badge: "D4",
      details: {
        body: "Kleiberit 568.1 Supracon to jednokomponentowy klej PUR sieciujący pod wpływem wilgoci z powietrza. Identyczne parametry techniczne co 568.0 — różni się wyłącznie formatem opakowania: kartusz 400 ml zamiast 310 ml. Ekstremalnie szybkie wiązanie, D4 + WATT 91, od +7°C.",
        keyFeature: "Klasa D4 + WATT 91 · czas otwarty 5 min · obciążalność po 15–30 min · skuteczny od +7°C. Większy kartusz 400 ml — lepsza ekonomika przy intensywnym użytkowaniu.",
        specs: [
          { label: "Baza", value: "1K PUR" },
          { label: "Klasa", value: "D4 (DIN EN 204) + WATT 91" },
          { label: "Barwa", value: "Jasnobeżowy" },
        ...
        applications: "Drewno i materiały drewnopochodne · beton, mur, tynk, cement · ceramika, marmur, kamień · twarde PVC, GRP, styropian, PUR · metale: miedź, stal szlachetna, aluminium, stal ocynkowana.",
        note: "Nie stosować do: PE, PP, PTFE (teflon), silikonu. 568.0 = 310 ml · 568.1 = 400 ml — identyczne parametry. Czyściwo: Kleiberit 820.0.",
      },
    },
  },
  {
