  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        code: "601.1",
        description: "Elastyczny klej STP 1K do montażu luster (DIN EN 1036), szkła, drewna i metali wewnątrz i na zewnątrz. Shore A 73, czas kożuszenia ok. 8 min, certyfikat EC1 plus R, klasa VOC A+. 4 kolory. Op. 12×280 ml.",
        type: "Montaż",
        image: "/placeholder.svg",
      },
      {
        ...
        code: "535.0",
        description: "Dwukomponentowa pianka PUR do montażu ościeżnic drzwi i izolacji okien. Bez gazu napędowego, bez naddatku, utwardza się niezależnie od wilgoci w 15–20 min. Klejowalna po 1 min, tnalna po 3–5 min. EC1 plus R, B2.",
        type: "Pianka PUR",
        image: "/placeholder.svg",
      },
      {
        ...
        code: "536.0",
        description: "Ekspansywna 2K pianka klejąca PUR do montażu stopni schodowych, progów drzwi i parapetów z drewna, kamienia lub metalu. Obciążalna po 20 min, bez gazu napędowego, bez naddatku, B2. Op. 125 g / 250 g.",
        type: "Pianka PUR",
        image: "/placeholder.svg",
      },
      {
        ...
        code: "585.5",
        description: "Trudnopalna 1K pianka PUR klasy B wg EN 13501-1 (różowa) do uszczelnień ognioodpornych między materiałem mineralnym lub metalowym. λ=0,036 W/mK, odporność –40 do +90°C. Op. 12×750 ml.",
        type: "Pianka PUR",
        image: "/placeholder.svg",
      },
    ],
